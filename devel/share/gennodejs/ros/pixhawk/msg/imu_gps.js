...
class imu_gps {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('lontitude')) {
        this.lontitude = initObj.lontitude
      }
      else {
        this.lontitude = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [lontitude]
    bufferOffset = _serializer.float32(obj.lontitude, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new imu_gps(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [latitude]
    data.latitude = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [lontitude]
    data.lontitude = _deserializer.float32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new imu_gps(null);
    ...
    if (msg.lontitude !== undefined) {
      resolved.lontitude = msg.lontitude;
    }
    else {
      resolved.lontitude = 0.0
    }
