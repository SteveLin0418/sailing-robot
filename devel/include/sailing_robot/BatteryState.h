// Generated by gencpp from file sailing_robot/BatteryState.msg
// DO NOT EDIT!


#ifndef SAILING_ROBOT_MESSAGE_BATTERYSTATE_H
#define SAILING_ROBOT_MESSAGE_BATTERYSTATE_H
...
struct BatteryState_
{
  ...
  typedef boost::shared_ptr< ::sailing_robot::BatteryState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sailing_robot::BatteryState_<ContainerAllocator> const> ConstPtr;

}; // struct BatteryState_

typedef ::sailing_robot::BatteryState_<std::allocator<void> > BatteryState;

typedef boost::shared_ptr< ::sailing_robot::BatteryState > BatteryStatePtr;
typedef boost::shared_ptr< ::sailing_robot::BatteryState const> BatteryStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sailing_robot::BatteryState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sailing_robot::BatteryState_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::sailing_robot::BatteryState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sailing_robot::BatteryState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sailing_robot::BatteryState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sailing_robot::BatteryState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sailing_robot::BatteryState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sailing_robot::BatteryState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sailing_robot::BatteryState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "e79052f91957c39a63c25e7746e9b091";
  }

  static const char* value(const ::sailing_robot::BatteryState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe79052f91957c39aULL;
  static const uint64_t static_value2 = 0x63c25e7746e9b091ULL;
};

template<class ContainerAllocator>
struct DataType< ::sailing_robot::BatteryState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "sailing_robot/BatteryState";
  }
...
template<class ContainerAllocator>
struct Definition< ::sailing_robot::BatteryState_<ContainerAllocator> >
{
  static const char* value()
  {
...
\n\
Header  header\n\
float32 power            # Power in mW\n\
float32 voltage          # Voltage in Volts (Mandatory)\n\
float32 current          # Negative when discharging (mA)  (If unmeasured NaN)\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sailing_robot::BatteryState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sailing_robot::BatteryState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sailing_robot::BatteryState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // SAILING_ROBOT_MESSAGE_BATTERYSTATE_H
